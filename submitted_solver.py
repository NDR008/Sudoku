...
def get_zeros_backtrack(sudoku):
    # ideally I check both rows/columns/boxes for best starting place
    # but the searching process added time
    if blanks(sudoku) > 26:  # it is a fudge value - 26 and it almost doesn't matter
        row_list = [0] * 9
